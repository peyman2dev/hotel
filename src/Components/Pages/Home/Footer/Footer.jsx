    ...
    <footer class="bg-white -800">
     ...
     {/* Useful Links */}
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center -400">
            © کلیه اطلاعات برای پیمان احمدی محفوظ می باشد
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="#"
              class="text-gray-500 hover:text-gray-900 -white"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              href="#"
              class="text-gray-500 hover:text-gray-900 -white ms-5"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
